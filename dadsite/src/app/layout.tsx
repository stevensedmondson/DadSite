  ...
  return (
    <html lang="en" className={work.className}>
      <body className="bg-[url('/Background.png')] bg-fixed bg-cover bg-no-repeat bg-top">
        ...
        <div className="flex justify-center font-semibold w-[90vw] mt-0 mb-10 pb-10">
        ...
        <div className="w-[90vw] h-auto lg:h-[20rem] mt-10 bg-[#5d7a8c] lg:grid lg:grid-cols-2 text-white justify-center ">
